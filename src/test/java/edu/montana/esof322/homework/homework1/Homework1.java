...
public class Homework1 {
    ...
    void useABuilder() {
        ...
        Student s = Student.builder().withFirstName("Joe").withLastName("Smith").withId("An ID").build();
        ...
        Student s2 = Student.builder().withFirstName("Joe").withLastName("Smith").withId(null).build();
    ...
    void createABuilder() {
        ...
        Ski ski = Ski.builder().withLength(180).withBrand("dps").withName("Alchemist Lotus").build();
